...
$sql4='SELECT * FROM contenido WHERE cont_id=1';
...
?>
<input type="button" class="access" title="Acceder" value="Probar en L&iacute;nea" id="login">
</div></div>
</article>
<article class="cent"></article>
<article><div class="vertical-slider2"><ul><?php  
$sql3='SELECT * FROM imagenes WHERE id_imagen=4';
...
$.post('cursos/programacion_web_1/consul.php',{},function(exito){$('#popup').css('top', '-80px');$('#popup').html(exito)});	
